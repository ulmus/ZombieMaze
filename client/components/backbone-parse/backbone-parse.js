...
var application_id = "ICQW709bF4XjHdThejpTQKfnlY4Kv9UScVJFCIxX";
var rest_api_key = "F24YcmHeYlFDVglZH0rcLnFOuvUs6Eox4t5PbGVA";
var api_version = "1";
...
(function() {
    ...
    */
	...
	Backbone.sync = function(method, model, options) {
        ...
        else if ((options.query || options.limit) && method == "read") { //query and limit for Parse.com objects
			data = {};
			if (options.query){
				data.query = "where=" + JSON.stringify(options.query);
			}
			if (options.limit){
